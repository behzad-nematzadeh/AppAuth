...
package com.behzadnematzadeh.appauth;

import static com.behzadnematzadeh.appauth.Preconditions.checkNotNull;
...
import com.behzadnematzadeh.appauth.AuthorizationException.GeneralErrors;
import com.behzadnematzadeh.appauth.AuthorizationException.RegistrationRequestErrors;
import com.behzadnematzadeh.appauth.AuthorizationException.TokenRequestErrors;
import com.behzadnematzadeh.appauth.IdToken.IdTokenException;
import com.behzadnematzadeh.appauth.browser.BrowserDescriptor;
import com.behzadnematzadeh.appauth.browser.BrowserSelector;
import com.behzadnematzadeh.appauth.browser.CustomTabManager;
import com.behzadnematzadeh.appauth.connectivity.ConnectionBuilder;
import com.behzadnematzadeh.appauth.internal.Logger;
import com.behzadnematzadeh.appauth.internal.UriUtil;
...
public class AuthorizationService {
    ...
    private static Long mClockSkew;
    ...
    public AuthorizationService(@NonNull Context context) {
        this(context, AppAuthConfiguration.DEFAULT, 0L);
    }

    public AuthorizationService(@NonNull Context context, @Nullable Long clockSkew) {
        this(context, AppAuthConfiguration.DEFAULT, clockSkew);
    }
    ...
    private static class TokenRequestTask
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            if (response.idToken != null) {
                IdToken idToken;
                try {
                    idToken = IdToken.from(response.idToken, mClockSkew);
