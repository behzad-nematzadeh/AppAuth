...
```groovy
implementation 'com.github.behzad-nematzadeh:AppAuth:<version>'
```
...
[net.openid.appauth.AuthState](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthState.java)
class, and communicates with an authorization server through the use of the
[net.openid.appauth.AuthorizationService](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationService.java)
...
[AuthorizationRequest](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationRequest.java).
The request is dispatched using
[performAuthorizationRequest()](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationService.java#L159) on an AuthorizationService instance, and the response (an
[AuthorizationResponse](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationResponse.java) instance) will be dispatched to the activity of your choice,
expressed via an Intent.

Token requests, such as obtaining a new access token using a refresh token,
follow a similar pattern:
[TokenRequest](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/TokenRequest.java) instances are dispatched using
[performTokenRequest()](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationService.java#L252) on an AuthorizationService instance, and a
[TokenResponse](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/TokenResponse.java)
instance is returned via a callback.

Responses can be provided to the
[update()](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthState.java#L367)
methods on AuthState in order to track and persist changes to the authorization
state. Once in an authorized state, the
[performActionWithFreshTokens()](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthState.java#L449)
...
[AuthorizationServiceConfiguration](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationServiceConfiguration.java#L102)
...
[AppAuthConfiguration](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AppAuthConfiguration.java)
instances, which can be provided to
[AuthorizationService](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationService.java)
during construction.
...
[BrowserMatcher](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/BrowserMatcher.java), and supplying this to the builder of AppAuthConfiguration.
A BrowserMatcher is suppled with a
[BrowserDescriptor](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/BrowserDescriptor.java)
instance, and must decide whether this browser is permitted for the
authorization flow.

By default, [AnyBrowserMatcher](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/AnyBrowserMatcher.java)
is used.

For your convenience, utility classes to help define a browser matcher are
provided, such as:

- [Browsers](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/Browsers.java):
  contains a set of constants for the official package names and signatures
  of Chrome, Firefox and Samsung SBrowser.
- [VersionedBrowserMatcher](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/VersionedBrowserMatcher.java):
  will match a browser if it has a matching package name and signature, and
  a version number within a defined
  [VersionRange](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/VersionRange.java). This class also provides some static instances for matching
  Chrome, Firefox and Samsung SBrowser.
- [BrowserAllowList](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/BrowserAllowList.java):
...
- [BrowserDenyList](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/browser/BrowserDenyList.java):
...
[ConnectionBuilder](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/connectivity/ConnectionBuilder.java)
instance.
...
### Issues with [ID Token](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/IdToken.java#L118) validation

ID Token validation was introduced in `0.8.0` but not all authorization servers or configurations support it correctly.

- For testing environments [setSkipIssuerHttpsCheck](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AppAuthConfiguration.java#L129) can be used to bypass the fact the issuer needs to be HTTPS.
...
[RegistrationRequest](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/RegistrationRequest.java) and dispatch it using
[performRegistrationRequest](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationService.java#L278)
on your AuthorizationService instance.

The registration endpoint can either
be defined directly as part of your
[AuthorizationServiceConfiguration](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/AuthorizationServiceConfiguration.java),
...
cases, a [ClientAuthentication](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/ClientAuthentication.java)
...
- [ClientSecretBasic](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/ClientSecretBasic.java):
  includes a client ID and client secret as an HTTP Basic Authorization header.
- [ClientSecretPost](https://github.com/behzad-nematzadeh/AppAuth/blob/master/appauth/src/main/java/com/behzadnematzadeh/appauth/ClientSecretPost.java):
